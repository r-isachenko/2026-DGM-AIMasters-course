...
|---|---|---|---|
| 1 | January, 29 | <b>Lecture 1:</b> Logistics. Generative models overview and motivation. Problem statement. Divergence minimization framework. Autoregressive models (ImageGPT). | [slides](lectures/lecture1/Lecture1.pdf) |
...
| 11 | April, 16 | <b>Lecture 11:</b>  Flow matching. | [slides](lectures/lecture11/Lecture11.pdf) |
...
<!---
| 12 | April, 23 | <b>Lecture 12:</b> Conditional flow matching. One-sided and two-sided conditioning. | [slides](lectures/lecture12/Lecture12.pdf) |
|  |  | <b>Seminar 12:</b> TBD | |
| 13 | April, 30 | <b>Lecture 13:</b> Link with diffusion and score matching. Discrete diffusion motivation. Forward discrete process. Reverse discrete process. Discrete ELBO objective. | [slides](lectures/lecture13/Lecture13.pdf) |
|  |  | <b>Seminar 13:</b> TBD | |
| 14 | May, 7 | <b>Lecture 14:</b> Discrete diffusion for sequence. Absorbing diffusion. Continuous-time masked diffusion language model. Course overview. | [slides](lectures/lecture14/Lecture14.pdf) |
|  |  | <b>Seminar 14:</b>  The Final Recap | |
-->
