...
\begin{frame}{Reverse SDE}
	...
	\begin{align*}
		...
		d\bx &= \left(\bff(\bx, t) - g^2(t) \frac{\partial}{\partial \bx}\log p_t(\bx)\right) dt + g(t) d \bar{\bw} \;\; - \text{Reverse SDE}
	\end{align*}
	\eqpause
	\vspace{-0.7cm}
	\begin{itemize}
...
\begin{frame}{Continuous-Time Normalizing Flows}
	...
	\begin{itemize}
		...
		\item Use $\bv_{\btheta}(\bx, t)$ for deterministic sampling from the ODE.
	\end{itemize}
\end{frame}
%=======
\begin{frame}{Flow Matching}
	...
	\vspace{-0.5cm}
	\begin{itemize}
		\item There are infinitely many possible $\bv(\bx, t)$ between $\pd(\bx)$ and $p(\bx)$.
		\item The true vector field  $\bv(\bx, t)$ is \textbf{unknown}.
