...
\begin{frame}{Score-Based Generative Models Through SDEs}
	...
	\begin{block}{Theorem}
		...
		\[
			\frac{d \bmu(t, \bx(0))}{dt} = f(t) \bmu(t, \bx(0))
		\]
		\[
...
\begin{frame}{Score-Based Generative Models Through SDEs}
	...
	\begin{block}{Proof (Continued)}
		\vspace{-0.3cm}
		\[
			\bbE\left[d\bx | \bx(0) \right] = f(t) \bmu(t, \bx(0)) dt
		\]
        \eqpause
		\[
			\frac{d \bbE\left[\bx(t) | \bx(0) \right]}{dt} = \frac{d \bmu(t, \bx(0))}{dt} = f(t) \bmu(t, \bx(0)) 
		\]
	\end{block}
    \eqpause
	\vspace{-0.3cm}
