...
\end{frame}
%=======
\begin{frame}{Conical Gaussian Paths: Conditional Vector Field}
...
\end{frame}
%=======
\begin{frame}{Conical Gaussian Paths: CFM Objective}
	\myfootnotewithlink{https://arxiv.org/abs/2210.02747}{Lipman Y., et al. Flow Matching for Generative Modeling, 2022}
	\vspace{-0.5cm}
	\begin{multline*}
...
\end{frame}
%=======
\begin{frame}{CFM with Conical Paths: Training and Sampling}
	\myfootnotewithlink{https://arxiv.org/abs/2210.02747}{Lipman Y., et al. Flow Matching for Generative Modeling, 2022}
	\vspace{-0.3cm}
	\[
...
\end{frame}
%=======
\begin{frame}{Linear Interpolation: Vector Field and Objective}
	\myfootnotewithlink{https://arxiv.org/abs/2210.02747}{Lipman Y., et al. Flow Matching for Generative Modeling, 2022}
	\vspace{-0.3cm}
	\[
...
\end{frame}
%=======
\begin{frame}{CFM with Linear Interpolation: Training and Sampling}
	\myfootnotewithlink{https://arxiv.org/abs/2210.02747}{Lipman Y., et al. Flow Matching for Generative Modeling, 2022}
	\begin{itemize}
